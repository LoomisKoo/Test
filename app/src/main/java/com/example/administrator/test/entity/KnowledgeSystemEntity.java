...
public class KnowledgeSystemEntity {
    ...
    private List<KnowledgeType> data;
    ...
    public List<KnowledgeType> getData() {
        return data;
    }

    public void setData(List<KnowledgeType> data) {
        this.data = data;
    }
